...
const CommenterCard = ({ user }: { user: Commenter }) => {
  return (
    <Card>
      ...
      <div className="">手机：{user.phone}</div>
      <div className="">邀请码：{user.invitationCode}</div>
  ...
  return (
    <div className="space-y-4 pb-6">
      ...
      <div className="px-4 pt-4">
        <h1 className="text-xl font-bold text-gray-900 mb-1">接单用户管理</h1>
        <p className="text-sm text-gray-600">管理接单用户账号</p>
      </div>
